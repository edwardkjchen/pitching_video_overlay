...
def main():
    ...
    for i in range(len(video_files) - 1):
        ...
        stabilized1_path = os.path.join(output_dir, f"{base1}_stabilized_v05.mp4")
        stabilized2_path = os.path.join(output_dir, f"{base2}_stabilized_v05.mp4")

        scaled1_path = os.path.join(output_dir, f"{base1}_scaled_v05.mp4")
        scaled2_path = os.path.join(output_dir, f"{base2}_scaled_v05.mp4")
        
        tilt_aligned1_path = os.path.join(output_dir, f"{base1}_tilt_aligned_v05.mp4")
        tilt_aligned2_path = os.path.join(output_dir, f"{base2}_tilt_aligned_v05.mp4")
        
        trimmed1_path = os.path.join(output_dir, f"{base1}_trimmed_v05.mp4")
        trimmed2_path = os.path.join(output_dir, f"{base2}_trimmed_v05.mp4")
        
        final_overlay_path = os.path.join(output_dir, f"{base1}_overlay_{base2}_v05.mp4")
        ...
        stabilize_video(video1_path, stabilized1_path, 'motion_raw1_v05.csv', 'motion_smoothed1_v05.csv')
        stabilize_video(video2_path, stabilized2_path, 'motion_raw2_v05.csv', 'motion_smoothed2_v05.csv')
